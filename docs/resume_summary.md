...
* **Deployed a highly observable cloud infrastructure** on Vercel and Render using Docker and GitHub Actions, instrumenting the backend with Micrometer, Prometheus, and Grafana to monitor JVM metrics and HikariCP connection pools.
* **Secured the platform** using stateless JWT authentication, Spring Security, and cloud storage abstraction for document storage, intercepting all requests with custom MDC filters for structured correlation ID logging.

---

## LinkedIn Project Description

**Resume Analysis and Optimisation Engine | Java, Spring Boot, React, Docker**
...
🔹 **Cloud & DevOps:** Vercel, Render, Docker, GitHub Actions (CI/CD)
